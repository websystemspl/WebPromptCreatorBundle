        ...
        <div class="widget__body" v-if="props.elementData.openToggle">
            <div class="wpc-form wpc-form--full-width">
                <div class="wpc-form__field">
                    <label for="" class="wpc-form__label">Input</label>
                    <div class="wpc-form__input">
                        <select v-model="props.elementData.settings.input">
                            <option value="" disabled>Select</option>
                            <option :value="index" v-for="(inputElement, index) in inputStore.input">{{ index }}</option>
                        </select>
                    </div>
                </div>                    
            </div>
